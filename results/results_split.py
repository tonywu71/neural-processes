...
# Regression
args = argparse.Namespace(epochs=60, batch=64, task='mnist', num_context=25, uniform_sampling=True, model='CNP')
...
num_context = 100
model.load_weights(f'trained_models/CNP_model_mnist_context_100_uniform_sampling_True/' + "cp-0030.ckpt")
# Split example
